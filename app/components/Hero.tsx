...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white dark:bg-slate-950">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-orange-50 via-white to-amber-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950"></div>
      ...
      {/* Subtle glow effects */}
      <div className="absolute top-1/4 -left-48 w-96 h-96 bg-orange-500/10 dark:bg-orange-500/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-1/4 -right-48 w-96 h-96 bg-amber-500/10 dark:bg-amber-500/5 rounded-full blur-3xl"></div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                href="/videos"
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-orange-600/20 hover:shadow-xl hover:shadow-orange-600/30 hover:scale-[1.02] active:scale-[0.98]"
              >
          ...
          <div className="lg:col-span-5 flex items-center justify-center lg:justify-end">
            <div className="relative">
              {/* Decorative elements */}
              <div className="absolute -inset-4 bg-linear-to-r from-orange-600 to-amber-600 rounded-full opacity-20 blur-2xl"></div>

              {/* Main image container */}
              <div className="relative">
                <div className="absolute -inset-1 bg-linear-to-r from-orange-600 via-amber-600 to-orange-600 rounded-full blur-sm opacity-75"></div>
